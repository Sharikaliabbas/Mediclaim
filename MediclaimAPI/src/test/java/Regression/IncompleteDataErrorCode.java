...
public class IncompleteDataErrorCode extends Base{
  	...
  	public void MultipleBillErrorCode() throws Exception {
  		  ...
  		  // Minio.writeJsonFile(transaction_id);
  			  ...
  			  .then().assertThat().statusCode(200).body("status",equalTo("REJECTED")).and().body("errorCode",equalTo("REPORT_ERROR")).and().body("reportStatus", equalTo("E_INCOMPLETE_DATA"))
