...
public class SuccessfulReportGenerationCallBackFailure extends Base{
	
  	@Test
	   public void SuccessfulReportGeneration_CallbackFailure() throws Exception
	   {
	   ...
	   if(properties.getProperty("ORG").equals("acme")) {
		...
		UploadingJSONResponseToMinio.writeJsonFile(transaction_id);
		  ...
		  .then().assertThat().statusCode(200).body("status",equalTo("ERROR_DELIVERING_REPORT"))
