...
public class PoorQualityErrorCode extends Base{

  	@Test
  	public void PoorQuality_ErrorCode() throws Exception {
  		  ...
  		  // Minio.writeJsonFile(transaction_id);
  		   	...
  		   	PublishingResponseToRedis.connectToJedis(Payloads.PoorQuality(organisation,transaction_id));
  			  ...
  			  .then().assertThat().statusCode(200).body("status",equalTo("REJECTED")).and().body("errorCode",equalTo("REPORT_ERROR")).and().body("reportStatus", equalTo("LOW_QUALITY"))
