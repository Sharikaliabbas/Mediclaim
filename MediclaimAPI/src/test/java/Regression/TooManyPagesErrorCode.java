...
public class TooManyPagesErrorCode extends Base{

  	@Test
  	public void TooManyPages_ErrorCode() throws Exception {
  		  ...
  		  // Minio.writeJsonFile(transaction_id);
  		   	...
  		   	PublishingResponseToRedis.connectToJedis(Payloads.TooManyPagesErrorCode(organisation,transaction_id));
  			  ...
  			  .then().assertThat().statusCode(200).body("status",equalTo("REJECTED")).and().body("errorCode",equalTo("REPORT_ERROR")).and().body("reportStatus", equalTo("BILL_TOO_MANY_PAGES"))
