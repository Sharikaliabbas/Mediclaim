...
public class MultipleBillErrorCode extends Base{

  	@Test
  	public void MultipleBill_ErrorCode() throws Exception {
  		  ...
  		  // Minio.writeJsonFile(transaction_id);
  			  ...
  			  .then().assertThat().statusCode(200).body("status",equalTo("REJECTED")).and().body("errorCode",equalTo("REPORT_ERROR")).and().body("reportStatus", equalTo("E_DATA_MULTIPLE_ENTITIES"))
